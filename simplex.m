...
for i = 1:100
    ...
    if (flag1 == 0)
        for k=1:165
            Error1 = Error1 + abs(sqrt(((x(k)-a1)^2) + ((y(k)-b1)^2)) - r1);
        end
        flag1=1;
        Error1 = abs(Error1);
    ...
    if (flag2 == 0)
        for k=1:165
            Error2 = Error2 + abs(sqrt(((x(k)-a2)^2) + ((y(k)-b2)^2)) - r2);
        end
        flag2=1;
        Error2 = abs(Error2);
    end
    ...
    if (flag3 == 0)
        for k=1:165
            Error3 = Error3 + abs(sqrt(((x(k)-a3)^2) + ((y(k)-b3)^2)) - r3);
        end
        flag3=1;
        Error3 = abs(Error3);
    end
    ...
    if (flag4 == 0)
        for k=1:165
            Error4 = Error4 + abs(sqrt(((x(k)-a4)^2) + ((y(k)-b4)^2)) - r4);
        end
        flag4=1;
        Error4 = abs(Error4);
    end
